      ...
      <div className="max-w-[1200px] mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: "#6B7280" }}>{anomalies.length} active alert{anomalies.length !== 1 ? "s" : ""} across the network</p>
          </div>
        ...
        {anomalies.length === 0 ? (
          <div className="rounded-xl border p-16 text-center" style={{ background: "#FFFFFF", borderColor: "#C8D8EE" }}>
          ...
          <AlertsGrid anomalies={anomalies} />
        )}
      </div>
    </div>
  );
