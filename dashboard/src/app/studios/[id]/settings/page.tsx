      ...
      <div className="max-w-[1340px] mx-auto px-6 py-8">
        ...
        <div className="mb-8 rounded-xl overflow-hidden relative" style={{ height: 160 }}>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
            <h1 style={{ fontFamily: "var(--font-montserrat), Montserrat, sans-serif", fontSize: 38, fontWeight: 800, color: "#fff", letterSpacing: "0.08em", lineHeight: 1.1, marginBottom: 4, textTransform: "uppercase" }}>Settings</h1>
